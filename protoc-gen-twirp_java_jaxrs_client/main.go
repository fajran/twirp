...
func (g *generator) generateClientFile(file *descriptor.FileDescriptorProto, service *descriptor.ServiceDescriptorProto, outerClass string) *plugin.CodeGeneratorResponse_File {
	...
	resp.Name = proto.String(javaFileName(file, outerClass, service))
...
func javaFileName(file *descriptor.FileDescriptorProto, outerClass string, service *descriptor.ServiceDescriptorProto) string {
